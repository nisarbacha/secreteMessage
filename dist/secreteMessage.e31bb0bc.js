...
var decrypted = atob(hash.replace('#', ''));
if (decrypted) {
...
document.querySelector('form').addEventListener('submit', function (event) {
  ...
  var messageFrom = document.querySelector('#message-form');
  ...
  linkInput.value = "".concat(location, "#").concat(encrypted);
  linkInput.select();
});
...
//# sourceMappingURL=/secreteMessage.e31bb0bc.js.map